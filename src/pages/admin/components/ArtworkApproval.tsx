  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={fetchPendingArtworks} variant="outline">
          Actualizar
        </Button>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-8 bg-muted/30 rounded-lg border">
          <p className="text-muted-foreground">
            No hay obras pendientes de aprobación
          </p>
        </div>
      ) : (
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm">
                      {selectedArtwork.profiles?.first_name}{" "}
                      {selectedArtwork.profiles?.last_name}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      {selectedArtwork.category || "No especificada"}
                    </p>
                  </div>
                  <div>
